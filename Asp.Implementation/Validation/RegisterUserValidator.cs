...
namespace Asp.Implementation.Validation
{
    public class RegisterUserValidator : AbstractValidator<RegisterDto>
    {
        ...
        public RegisterUserValidator(AspDbContext context)
        {
            _context = context;
            ...
            RuleFor(x => x.Email).Cascade(CascadeMode.Stop)
                                 ...
                                 .MaximumLength(35).WithMessage("Email must not exceed 35 characters.")
                                 .EmailAddress()
                                    .WithMessage("Email {PropertyValue} is not in correct format.")
